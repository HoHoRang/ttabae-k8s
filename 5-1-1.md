...
# 1. Pod 개념 및 사용하기
## Container 정리
- 코드 작성 및 도커 빌드![[attachments/Pasted image 20260301134350.png]]
- 컨테이너 하나 = 애플리케이션 하나
## Pod란?
- 컨테이너를 표현하는 k8s API의 최소 단위
- 쿠버네티스에서는 master node에 Pod를 실행하라고 요청![[attachments/Pasted image 20260301134631.png]]
- API를 통해서 컨테이너 동작은 불가함
- 대신, Pod API를 통해 컨테이너를 실행함
- Pod에는 하나 또는 여러 개의 컨테이너가 포함될 수 있음
- ![[attachments/Pasted image 20260301134931.png]]
## Pod 생성하기
